...
function App() {
  ...
  const [dateRange, setDateRange] = useState(() => {
    // Default: últimos 90 días (garantiza datos visibles aunque el sync esté atrasado).
    const now = new Date();
  ...
  const dateLabel = (() => {
    ...
    if (dateRange.startDate === dateRange.endDate) {
      return startObj.toLocaleDateString("es-MX", {
        day: "numeric",
        month: "long",
        year: "numeric",
      });
    ...
    if (sM === eM && sY === eY) {
      const monthYear = endObj.toLocaleDateString("es-MX", {
        month: "long",
        year: "numeric",
      });
    ...
    const startStr = startObj.toLocaleDateString("es-MX", {
      day: "numeric",
      month: "long",
    });
    const endStr = endObj.toLocaleDateString("es-MX", {
      day: "numeric",
      month: "long",
      year: "numeric",
    });
  ...
  return (
    <div
      className="min-h-screen relative py-2 px-0 sm:py-3 sm:px-1 lg:py-4 lg:px-2"
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none z-[-3]">
        ...
        <div
          className="absolute top-[50%] right-[5%] w-[500px] h-[500px] rounded-full bg-blue-500/25 blur-[120px] animate-pulse"
          style={{ animationDelay: "1s" }}
        />
        <div
          className="absolute bottom-[5%] left-[20%] w-[450px] h-[450px] rounded-full bg-sky-500/25 blur-[100px] animate-pulse"
          style={{ animationDelay: "2s" }}
        />
        <div
          className="absolute top-[30%] left-[50%] w-[400px] h-[400px] rounded-full bg-indigo-500/20 blur-[100px] animate-pulse"
      ...
      <motion.div
        ...
        style={{
          ...
          boxShadow:
            "0 0 80px rgba(0, 0, 0, 0.5), inset 0 1px 0 rgba(255, 255, 255, 0.05)",
        }}
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, rgba(20, 184, 166, 0.1) 0%, transparent 50%, rgba(168, 85, 247, 0.08) 100%)",
        ...
        {activeView === "dashboard" && (
          <main className="w-full px-4 sm:px-6 lg:px-10 xl:px-16 py-6 sm:py-10 lg:py-12">
            ...
            {data && (
              <div
                className={`space-y-6 sm:space-y-8 lg:space-y-10 transition-opacity duration-300 ${loading ? "opacity-50 pointer-events-none" : "opacity-100"}`}
              >
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div>
                      ...
                      <p className="text-base text-white/40 mt-2">
                        Oportunidades que entraron a cada etapa en el periodo
                        seleccionado
                      </p>
                    </div>
                  ...
                  >
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <div className="flex gap-6 text-base">
                        ...
                        <span className="flex items-center gap-2">
                          <span
                            className="w-3 h-3 rounded-full bg-gradient-to-r from-sky-400 to-indigo-400"
                            style={{
        ...
        <footer className="border-t border-white/[0.06] mt-16 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-center gap-3">
              <div
                className="w-2 h-2 rounded-full bg-gradient-to-r from-teal-400 to-cyan-400 animate-pulse"
